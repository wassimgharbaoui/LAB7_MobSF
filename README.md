...
<!-- 📸 IMAGE À AJOUTER : capture de la liste des AVD dans le terminal (résultat de `emulator -list-avds`) -->
![AVD créé avec succès](images/etape1_avd_liste.png)
...
![Contenu du dossier scripts](images/etape2_scripts.png)
...
<!-- 📸 IMAGE À AJOUTER : capture du terminal montrant le lancement du script android_emulator.sh -->
![Lancement du script MobSF](images/etape3_script.png)

<!-- 📸 IMAGE À AJOUTER : capture du terminal montrant `adb devices` et `adb root` avec les résultats attendus -->
![Connexion ADB et activation du root](images/etape3_adb_root.png)

<!-- 📸 IMAGE À AJOUTER : capture du terminal montrant `adb remount` avec le message "remount succeeded" -->
![Remount réussi](images/etape3_remount.png)
...
<!-- 📸 IMAGE À AJOUTER : capture du rapport statique MobSF après upload de diva.apk (page de résultats complète ou section Security Score) -->
![Rapport statique MobSF — DIVA](images/etape6_analyse_statique.png)
...
<!-- 📸 IMAGE À AJOUTER : capture du bouton / icône dans MobSF pour lancer l'analyse dynamique -->
![Bouton démarrer l'analyse dynamique](images/etape6_bouton_dynamic.png)
